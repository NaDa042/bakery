...
// Draws product list by category
function drawProducts() {
    const categories = {
        cakes: [100, 101, 102, 103, 104],
        cupcake: [105, 106, 107, 108, 109],
        croissant: [110, 111, 112, 113, 114],
        cookies: [115, 116, 117, 118, 119],
        donut: [120, 121, 122, 123, 124],
        rolls: [125, 126, 127, 128, 129]
    };
...
document.querySelectorAll(categorySelectors).forEach(container => {
    container.addEventListener('click', (e) => {
        ...
        let productId = e.target.parentNode.getAttribute('data-productId') * 1;
